...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'Accelerometer Game'),
    );
  }
}
      ...
      body: Column(
        children: [
          Padding(
            ...
            child: Text('Keep the circle in the center for 1 second',style: TextStyle(
              fontSize: 20.0,
            ...
            children: [
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  width: 100,
                  decoration: BoxDecoration(
                    border: Border.all(color: Colors.amber[900], width: 2.0),
          ...
          Text('Accelerometer Values',style: TextStyle(
            color: Colors.red[900],
            fontWeight: FontWeight.w700
          ),),
          Text('x: ${(event?.x ?? 0).toStringAsFixed(1)}'),
          Text('y: ${(event?.y ?? 0).toStringAsFixed(1)}'),
        ],
      ),
